...
def test_vacc_person_instantiation():
    ...
    virus = Virus("Shash", .69, .96)
    person1 = Person(11, True, virus) 
    assert person1._id == 11
    assert person1.infection.repro_rate == .69
    assert person1.infection.mortality_rate == .96
